...
Ids_Dev = {sudos.Id_DevOlifay,933655370,373906612}
Name_Bot = (redis:get(bot_id.."Olifay:Redis:Name:Bot") or "اولفاي")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
download_to_file('https://raw.githubusercontent.com/Olifayy/Olifay/master/Olifay.lua','Olifay.lua') 
...
local url,res = https.request('https://teamstorm.tk/chhh/?id='..msg.sender_user_id_)
